<?php
/* $Id: pdfa_extension_schema_with_type.php,v 1.3 2012/05/03 14:00:37 stm Exp $
* PDF/A extension schema with type:
...
* supply an XMP file containing a complex XMP extension schema which requires a
...
$outfile = "";
$title = "PDF/A Extension Schema with Type";
...
$xmpfile = "machine_extension_schema_2.xmp";
...
try {
    ...
    header("Content-Disposition: inline; filename=pda_extension_schema_with_type.pdf");
    print $buf;
